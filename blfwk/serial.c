...
int serial_setup(int fd, long speed)
{
    speed_t speedToSet;
#if defined(WIN32)
    ...
    printf("Initial tty speed x%08x\n", cfgetospeed(&tty));
    ...
    cfsetospeed(&tty, speedToSet);
    cfsetispeed(&tty, speedToSet);
    ...
    printf("Configuring tty speed x%08x\n", speedToSet);
    ...
    printf("Configured tty speed x%08x\n", cfgetospeed(&tty));
